...
Final Buy Decision: ${decision}`);
    ...
    evaluateSell(entry, position, config) {
        ...
        const trailingTpPercent = getThreshold("TRAILING_TP_PERCENT") || 0.05;
        ...
        const trailingStop = (position?.highestPrice !== undefined && position?.highestPrice !== null) ? (ind.price < position.highestPrice * (1 - trailingStopPercent)) : false;
